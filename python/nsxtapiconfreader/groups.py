...
#from nsxtapiconfreader.configreader import Configmap
#from configreader import Configmap
...
def main():
    ...
    security_context = create_user_password_security_context(nsxtmgr1_usr,nsxtmgr1_pwd )
